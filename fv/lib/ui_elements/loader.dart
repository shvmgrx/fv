...
import 'package:infv1/ui_elements/dot_type.dart';
import 'dart:math';
...
class ColorLoader5 extends StatefulWidget {
  ...
  final Icon dotIcon;
   ...
   // Color dotOneColor = Color(0xff280072);
  //  Color dotTwoColor = Color(0xffefe6e0);
  //  Color dotThreeColor = Color(0xffd07155);


  ColorLoader5({
    this.dotOneColor = Colors.grey,
    this.dotTwoColor = Colors.blueGrey,
